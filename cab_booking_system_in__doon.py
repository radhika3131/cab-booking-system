...
class travel:
    ...
    def __init__(self,root):
        self.root = root
        self.root.title("Cab Booking System In DOON")
    ...
    #==========================================Define Functiom==================================================
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "Sahastradhara":
                    switch ={"Nehru Colony": 10,"Masoori": 8,"GMS Road":6,"Sahastradhara": 0}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Nehru Colony":
                    switch ={"Nehru Colony": 0,"Masoori": 2,"GMS Road":5,"Sahastradhara": 10}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Masoori":
                    switch ={"Nehru Colony": 2,"Masoori": 0,"GMS Road":3,"Sahastradhara": 8}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "GMS Road":
                    switch ={"Nehru Colony": 5,"Masoori": 3,"GMS Road":0,"Sahadtradhara": 6}
                    Km.set(switch[varl2.get()])        
   ...
   #================================================mainframe========================================================================
        ...
        self.lblTitle=Label(Tops,font=('arial',70,'bold'),text=" Cab Booking System in DOON ")
        self.lblTitle.grid()
    ...
    #===============================================Taxi Information==============================================================
        ...
        self.cboPickup['value']=('','Sahastradhara','GMS Road','Masoori','Nehru Colony')
        self.cboPickup.current(0)
        ...
        self.cboDrop['value']=('','Nehru Colony','Masoori','Sahastradhara','GMS Road')
        self.cboDrop.current(0)
